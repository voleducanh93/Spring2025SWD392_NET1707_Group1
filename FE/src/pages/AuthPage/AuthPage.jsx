      ...
      <div className={styles.formsContainer}>
        <div className={styles.signinSignup}>
          <Form
            ...
            wrapperCol={{ span: 24 }}
            style={{ maxWidth: 600 }}
            className={`${styles.signInForm} ${isSignUpMode ? styles.hidden : ""} mx-auto`} // Adjusted margin-top for proper spacing
          ...
          >
            ...
            >
              <Input
                ...
                className="w-full " // Full width and margin-top for spacing
              />
            </Form.Item>
            ...
            <Button
              type="primary"
              htmlType="submit"
              className="w-full mt-4" // Full width for the button and margin-top for spacing
            >
              Đăng nhập
            </Button>
            ...
            <Link
              ...
              className="ml-4 text-blue-500 hover:text-blue-700 font-semibold py-2 px-4 rounded-md transition duration-300 ease-in-out hover:bg-blue-100 text-center block mx-auto mt-4"
            >
              Quên mật khẩu?
            </Link>
            ...
            <div className="mt-4 flex flex-col lg:flex-row items-center justify-center w-full">
          ...
          <Form
            ...
            labelCol={{ span: 24 }}
            wrapperCol={{ span: 24 }}
            style={{ maxWidth: 600, margin: "0 auto" }} // Center the form container
            className={`${styles.signUpForm} ${isSignUpMode ? "" : "hidden"} `}
            onFinish={handleOnFinish}
            onValuesChange={handleFormValuesChange}
            initialValues={formValues}
            preserve={true}
