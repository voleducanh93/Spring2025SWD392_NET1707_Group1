...
const initialVaccines = [
  ...
  { id: 2, name: "Moderna", description: "COVID-19 Vaccine", manufacturer: "Moderna Inc.", sideEffect: "Headache", diseasePrevented: "COVID-19", price: 22, status: "Available", injectionSite: "Arm", preserve: "Cold storage", notes: "Store at -20C" }
];

const initialVaccineInventory = [
  { id: 1, vaccineId: 1, batchNumber: "B12345", manufacturingDate: "2023-01-15", initialQuantity: 500, quantityInStock: 200, supplier: "Pfizer Inc.", expiryDate: "2025-01-15" },
  { id: 2, vaccineId: 2, batchNumber: "M56789", manufacturingDate: "2023-02-10", initialQuantity: 400, quantityInStock: 150, supplier: "Moderna Inc.", expiryDate: "2025-02-10" }
];
...
export default function ManagerPage() {
  ...
  const handleDeleteInventory = (id) => {
    setVaccineInventory(vaccineInventory.filter(inventory => inventory.id !== id));
  };
            ...
            <TableBody>
              {vaccines.map((vaccine) => (
                <TableRow key={vaccine.id}>
                  ...
                  <TableCell>
                    <Button variant="outline" size="icon" className="mr-2"><Edit size={16} /></Button>
                    <Button variant="destructive" size="icon" onClick={() => handleDeleteVaccine(vaccine.id)}><Trash size={16} /></Button>
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
            ...
            <TableBody>
              {vaccineInventory.map((inventory) => (
                <TableRow key={inventory.id}>
                  ...
                  <TableCell>
                    <Button variant="outline" size="icon" className="mr-2"><Edit size={16} /></Button>
                    <Button variant="destructive" size="icon" onClick={() => handleDeleteInventory(inventory.id)}><Trash size={16} /></Button>
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
